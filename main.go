...
import (
	...
	"strings"
	"time"
	"ecpay.test.com/pkg/encrypt"
)

type EcpayInvoiceRes struct {
	MerchantID string
	Data string
}

var merchantID = "2000132"
var key = "ejCk326UnaZWKisg"
var iv = "q9jcZX8Ib9LM8wYk"
...
func EncodeDataHandle() string{
	...
	encode, _ := encrypt.AesEncryptSimple([]byte(str), key, iv)
